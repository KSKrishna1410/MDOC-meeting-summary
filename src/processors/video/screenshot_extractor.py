...
class ScreenshotExtractor:
    ...
    def extract_all_speech_keywords(self):
        """
        ...
        if self.use_ai_speech_analysis and self.speech_timestamps:
            ...
            try:
                ...
                ai_results = analyze_speech_for_screenshot_moments(self.speech_timestamps)
    ...
    def two_phase_process(self, video_processor, fps, frame_count, progress_callback=None):
        """
